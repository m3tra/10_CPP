...
void			Bureaucrat::signForm(Form& form) {
	if (form.isSigned()) {
		...
		std::cout << PURPLE "        It was already signed" WHITE << std::endl << std::endl;
		return;
	}
	try {
		form.beSigned(*this);
		...
		std::cout << "    " << form << std::endl;
		std::cout << "    because" << std::endl;
		std::cout << PURPLE "        " << e.what() << WHITE << std::endl << std::endl;
	}
}
...
void			Bureaucrat::executeForm(Form const & form) {
	try {
		...
		std::cout << BLUE << *this << std::endl;
		std::cout << GREEN "executed" << std::endl;
		std::cout << "    " << form << std::endl << std::endl;
	}
	catch(std::exception & e) {
		std::cout << BLUE << *this << std::endl;
		std::cout << RED "couldn't execute" << std::endl;
		std::cout << "    " << form << std::endl;
		std::cout << "    because" << std::endl;
		std::cout << PURPLE "        " << e.what() << WHITE << std::endl << std::endl;
	}
